...
$query = "SELECT * FROM categories ORDER BY category_id " . $admin_preference['orderby'];
      ...
      <div class="col ms-3">
        ...
        <div>
          <div class="row mt-4" style="color:#929AA6;">
            <div class="col">Found <span style="color:#DEE0E0;"><?= $categories_count ?></span> Categories</div>
